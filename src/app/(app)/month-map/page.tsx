          ...
          <Card key={month}>
            ...
            <CardContent className="p-4 pt-0">
              <Textarea
                ...
                className="resize-none h-40 leading-loose bg-transparent"
                style={{
                  backgroundImage: 'repeating-linear-gradient(to bottom, hsl(var(--border)) 0 1px, transparent 1px 1.5rem)',
                  lineHeight: '1.5rem',
